    ...
    <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2 ml-auto">
                        <button
                          ...
                          className="cursor-pointer px-3 py-1.5 text-xs font-medium border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50"
                        >
                          Cancel
                        </button>
                        <button
                          ...
                          className="cursor-pointer flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-60 transition-colors"
                        >
                          {replySubmitting ? (
      ...
      <div className="bg-white pt-2 pb-2 flex items-center justify-center gap-3">
        <button
          ...
          disabled={page === 1}
          className="cursor-pointer flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-40"
        >
