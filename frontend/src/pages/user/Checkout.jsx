            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="lg:w-2/3 space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        {showAddForm && (
                            <form onSubmit={handleAddAddress} className="mb-8 p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div className="flex justify-end gap-2">
                                    <button type="button" onClick={() => setShowAddForm(false)} className="px-4 py-2 text-gray-500 hover:text-gray-700">Cancel</button>
                                    <button type="submit" className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Save Address</button>
                                </div>
                            </form>
                        )}
