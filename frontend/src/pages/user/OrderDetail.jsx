      ...
      <div className="mb-8 border-b border-gray-100 pb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-start md:items-end gap-2">
            ...
            {/* Action Bar - Mobile (Fixed Grid Layout to prevent alignment issues) */}
            <div className="grid md:hidden grid-cols-2 gap-3 w-full mt-4">
              <button
                onClick={handleDownloadInvoice}
                disabled={isDownloading}
                className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-slate-200 bg-white shadow-sm"
              >
              ...
              {isCancellable && (
                <button
                  onClick={() => setShowCancelModal(true)}
                  className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-red-100 bg-red-50"
                >
              ...
              {isReturnable && (
                <button
                  onClick={() => setShowReturnModal(true)}
                  className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-orange-100 bg-orange-50"
                >
                  <div className="text-orange-500">
                    <RotateCcw size={18} />
                  </div>
                  <span className="text-[11px] font-bold text-orange-700 uppercase text-center">
                    Return
                  </span>
                </button>
              )}
              ...
              {order.status === "delivered" && unreviewedItems.length > 0 && (
                <button
                  onClick={() => handleReviewClick(unreviewedItems[0].id)}
                  className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-indigo-100 bg-indigo-50"
                >
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
            <div className="divide-y divide-gray-200">
              {order.orderItems?.map((item) => (
                ...
                >
                  <div className="h-24 w-24 sm:h-28 sm:w-28 flex-shrink-0 mx-auto sm:mx-0 overflow-hidden rounded-md border border-gray-200 bg-white p-2">
                    <img
                      src={
                  ...
                  <div className="flex flex-1 flex-col">
                    <div>
                      <div className="flex justify-between items-start mb-1">
                        ...
                        <p className="font-extrabold text-indigo-600 ml-4 whitespace-nowrap">
                          {formatCurrency(
                    ...
                    <div className="flex flex-col xs:flex-row xs:items-center justify-between mt-4 gap-3">
                      <div className="text-sm text-gray-500 bg-white px-3 py-1.5 rounded-lg border border-gray-200 inline-flex items-center gap-1 w-fit shadow-sm">
                      ...
                      <div className="flex items-center pt-1 xs:pt-0">
                        {order.status === "delivered" && !item.review && (
                          <button
                            onClick={() => handleReviewClick(item.id)}
                            className="w-full xs:w-auto cursor-pointer text-xs font-black uppercase tracking-wider text-indigo-600 hover:text-white bg-indigo-50 hover:bg-indigo-600 px-4 py-2.5 rounded-xl transition-all border border-indigo-100 shadow-sm"
                          >
                            Leave a rating
                          </button>
                        )}
                        ...
                        {order.status === "delivered" && item.review && (
                          <span className="text-xs font-black uppercase tracking-wider text-emerald-600 flex items-center gap-1.5 bg-emerald-50 px-4 py-2.5 rounded-xl border border-emerald-100 shadow-sm">
                  ...
                  <>
                    ...
                    <div className="space-y-1.5 pt-3 border-t border-gray-200">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="font-bold text-slate-800 text-xs uppercase tracking-tight mt-1">
